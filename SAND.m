...
% ==============================================================================
X = data(1:695, 1:3594); y = data(1:695, 3599);		% SAND label only
...
% ==============================================================================
Xval = data(696:926, 1:3594); yval = data(696:926, 3599);	% SAND label only
% Add intercept
...
% ==============================================================================
Xtest = data(927:end, 1:3594); ytest = data(927:end, 3599);	% SAND label only
% Add intercept
